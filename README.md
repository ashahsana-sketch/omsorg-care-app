...
> **Sample Document:** [View PDF Payslip (Lönespecifikation)](https://github.com/ashahsana-sketch/omsorg-care-app/blob/main/src/Lonespecifikation_Anna_Lindberg_2026-08-31.pdf)


![Salary Slips & Payroll Overview](https://raw.githubusercontent.com/ashahsana-sketch/omsorg-care-app/main/src/Salary%20Slips%26Payroll.jpg)

---

## Key Features

- **Interactive Dashboard:** High-level overview of total staff, active care receivers, total scheduled hours, and real-time payroll estimates. Includes progress bars tracking weekly employee hour caps (e.g., 40h/week limit).
- **Staff & Care Team Management:** Detailed employee profiles tracking assigned roles (*Undersköterska*, *Vårdbiträde*, *Sjuksköterska*, *Personlig assistent*), contact details, hourly rates, and extra shift bonuses.
- **Client / Care Receiver Portal:** Directory of clients with addresses, specific care needs, and quick actions to assign dedicated shifts.
- **Roster & Shift Scheduling:** Modal-driven shift builder with built-in validation (e.g., availability alerts, max hour warnings, extra shift bonus inputs).
- **Payroll & Payslip Generation:** Automatic gross/net salary calculations (including preliminary 30% tax deductions and bonuses) with printable PDF payslip support (*Lönespecifikation*).
- **Multi-language Support:** Built-in internationalization context supporting Swedish (SV) and English (EN).
